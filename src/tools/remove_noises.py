...
def parse_arguments(argv):
  ...
  parser.add_argument('--facescrub-noises', type=str, help='', default='/data/datasets/megaface_testpack/facescrub_noises.txt')
  parser.add_argument('--megaface-noises', type=str, help='', default='/data/datasets/megaface_testpack/megaface_noises.txt')
  parser.add_argument('--algo', type=str, help='', default='tf-insightface')
  parser.add_argument('--facescrub-lst', type=str, help='', default='/data/datasets/megaface_testpack/facescrub_lst')
  parser.add_argument('--megaface-lst', type=str, help='', default='/data/datasets/megaface_testpack/megaface_lst')
  parser.add_argument('--feature-dir-input', type=str, help='', default='/data/zgs/face_id/build/mix_feature/')
  parser.add_argument('--feature-dir-out', type=str, help='', default='/data/zgs/face_id/build/mix_feature_clean/')
